            ...
            <div class="grid wide">
                <div class="page-banner">
                    <div class="page-title">
                        <h1>Chia sẻ bí kíp học ngoại ngữ</h1>
                    </div>
                    ...
                    <div class="page-breadcrumb">
                        <a class="page-banner-item" href="./home.php">Trang chủ</a>
                            ...
                            <a class="page-banner-item" href="./learning-tips.php">Bí kíp học ngoại ngữ</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="page-content white">
            <div class="grid wide">
                <div class="blog-list-wrapper">
                    <div class="row">
                        <div class="col l-8-5">
                            <ul class="blog-list all-blog">
                            <?php
                                    include "connect.php";
                                    $sql = "SELECT * FROM blog WHERE topic=1";
